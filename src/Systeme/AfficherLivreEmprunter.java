 ...
 * @author DIE SYLLA
 */
public class AfficherLivreEmprunter extends javax.swing.JFrame {
    ...
    public AfficherLivreEmprunter(String titre, String auteur, int anneePublication, String ISBN, String genre,boolean disponiblite) {
        this.titre = titre;
        this.auteur = auteur;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Livres Emprunter");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficherLivreEmprunter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AfficherLivreEmprunter().setVisible(true);
            }
        });
    }
